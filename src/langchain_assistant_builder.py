...
def main():
    ...
    agent = OpenAIAssistantRunnable.create_assistant(
        name="Nutri Buddy GPT3.5 w/GoogleSearch Langchain V1",
        instructions="""
        ...
        Priority:
        - Keep responses brief and accurate, only addressing the user's question.
        ...
        Specific Methods:
        - Translate to English and use the 'get_recipe' function when detailed steps or ingredient lists for specific recipes are requested.
        - Translate to English and use the 'find_restaurant_food' function with common food when specific restaurant food inquiries are made, especially when recommendations based on types of restaurants are sought.
